...
public class EntityUpdateEvent<EntityType> extends Event implements Cancellable {
    ...
    public EntityUpdateEvent(int queryId, StackTraceElement[] stackTraceElements, String query, PreparedStatement preparedStatement, EntityType databaseEntity, EntityType entity) {
